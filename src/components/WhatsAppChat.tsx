...
// // const WhatsAppChat = () => {
// //   const phoneNumber = "2349012345678"; // your WhatsApp number (no "+" or spaces)
...
// //       className="group fixed bottom-6 right-6 z-50 flex items-center space-x-2 bg-green-500 text-white py-3 px-4 rounded-full shadow-lg hover:bg-green-600 transition-all hover:scale-110"
// //     >
// //       <FaWhatsapp size={24} className="animate-pulse" />
// //       <span className="hidden text-sm sm:inline-block font-medium">Chat with us</span>
// //     </motion.a>
// //   );
// // };
...
//       setShowButton(window.scrollY > triggerHeight);
//     };
